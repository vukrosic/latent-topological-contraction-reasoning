...
\author{Vuk Rosić, Gemini\thanks{We thank Novita AI for providing the computational resources used in this research.} \\ \small \raisebox{-0.2\height}{\includegraphics[height=1.2em]{github-mark.png}} \ \href{https://github.com/vukrosic/latent-topological-contraction-reasoning}{vukrosic/latent-topological-contraction-reasoning}}
